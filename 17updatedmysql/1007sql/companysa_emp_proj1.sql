...
--
-- Table structure for table `emp_proj1`
--

DROP TABLE IF EXISTS `emp_proj1`;
...
--
-- Dumping data for table `emp_proj1`
--

LOCK TABLES `emp_proj1` WRITE;
/*!40000 ALTER TABLE `emp_proj1` DISABLE KEYS */;
/*!40000 ALTER TABLE `emp_proj1` ENABLE KEYS */;
UNLOCK TABLES;
